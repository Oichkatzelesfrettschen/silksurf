...
const COMMON_IDENTIFIERS: &[&str] = &[
    ...
    "Function", "Math", "Date", "RegExp", "Error", "JSON",
    ...
    // Common methods
    "prototype", "constructor", "length", "name", "message",
    ...
    "forEach", "find", "findIndex", "includes", "flat", "flatMap",
    "keys", "values", "entries",

    // Common property names
    "value", "writable", "enumerable", "configurable",
    "get", "set", "then", "catch", "finally",
    ...
    // Module-related
    "default", "exports", "module", "require", "__dirname", "__filename",

    // Common variable names
    "i", "j", "k", "n", "x", "y", "z",
    "a", "b", "c", "d", "e", "f", "g", "h",
    "el", "fn", "cb", "err", "res", "req", "ctx",
    "data", "result", "item", "items", "list", "arr",
    "obj", "key", "val", "prop", "props", "state",
    "event", "target", "type", "id", "index", "count",
    "start", "end", "left", "right", "top", "bottom",
    "width", "height", "size", "offset", "position",
];
