...
## Last refresh
  ...
  * Date: 2026-09-23. The HTML tree-construction corpus at revision
    `1924c6e9784b3c1da4ad5bfcbfeea64b2a886e7b` passes 1792 of 1918
    executed cases on source commit `3dd53da`. The parser executes document
    and fragment cases with context namespace and scripting state; the other
    harness rows retain their recorded measurement dates.
...
| **HTML tree construction (upstream WPT corpus)** | functional | 1918 cases from WPT `html/syntax/parsing/resources`; document and fragment cases use the production html5ever adapter | 1792 / 1918 executed = **93.43%**, 1792 / 1918 total = **93.43%**. The runner executes every fragment case and records 126 expected failures. Processing-instruction cases still reach html5ever's bogus-comment tokenizer path. See `docs/conformance/html5lib-tree-construction-scorecard.json` |
