 ...
 * implementation's own output and then passed through rustfmt; see
 * docs/design/ARCHITECTURE-DECISIONS.md AD-033 for why the table is
 * enumerated rather than derived.
 *
 * Generated from node ${process.versions.node} carrying ICU ${process.versions.icu}.
 * The patterns and names a CLDR release changes move with that version, so a
 * regeneration that shifts the table shows the version it shifted from.
 *
